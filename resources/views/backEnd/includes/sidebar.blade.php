    ...
    <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{route('add.sub.category')}}">New Sub Category</a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseBrand" class="collapse" aria-labelledby="headingBrand" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{route('add.sub.category')}}">New Brand</a>
                <a class="collapse-item" href="{{route('manage.sub.category')}}">Manage Brand</a>
            </div>
        </div>
